...
<x-public-layout>
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <section class="bg-red-600 text-white py-4 px-6 rounded shadow mb-6 text-center">
            ...
            <p class="text-sm md:text-base mt-1">Next Event: {{ $nextEvent->name }} · {{ $nextEvent->date->format('M j') }}</p>
        </section>
        ...
        <section>
            <h2 class="text-xl font-semibold mb-4 border-b border-red-500 pb-1">Race Feed</h2>
            <div class="space-y-6">
